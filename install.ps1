...
Write-Host "  1. Start proxy + Codex with GLM-5.2:`n     start-codex-glm52.cmd`n"
Write-Host "  2. Or manually start proxy then use profile:`n     start-proxy.cmd`n     codex --profile glm52`n"
